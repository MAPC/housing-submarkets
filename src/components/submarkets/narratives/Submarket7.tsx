...
const SubmarketSevenNarrative = () => (
  <React.Fragment>
    ...
    <SectionWithChart>
      <div>
        <p>
          Immigrants are underrepresented in Submarket 7 compared to the region overall—11 percent of people in the submarket were born in another country, ten points lower than in the region overall, and the smallest share of all the submarkets. [BOX PLOT?] Only one percent of residents don’t speak English well.
        </p>
        <p>
    ...
    <SectionWithChart>
      <div>
        <p>
          A lot of children live in Submarket 7 too. More households with children are located within Submarket 7 than any other submarket: 81,600, or 36 percent of all households. [BOX PLOT?]
        </p>
        <p>
    ...
    <SectionWithChart>
      <div>
        <p>
          Given the low cost of housing and the relative wealth of residents in Submarket 7, it is no surprise that the rate of severe cost burden in the submarket is lowest of the seven submarkets at 11 percent—5 points lower than the regional average. [BOX PLOT]
        </p>
        <p>
