  ...
  <>
    <SectionWithChart>
      <div>
        ...
        <p>
          Immigrants are underrepresented in Submarket 7 compared to the region overall—11 percent of people in the submarket were born in another country, ten points lower than in the region overall, and the smallest share of all the submarkets. Only one percent of residents have limited English.
        </p>
        <p>
    ...
    <SectionWithChart>
      <div>
        ...
        <p>
          ...
          />
          {' '}
          in Submarket 7 are second best of the submarkets, after Submarket 5, as is the measure of student test score improvement.
        </p>
        <p>
        ...
        <p>
          As the lowest-density submarket and the farthest from the core of the region, it is not surprising that it has the lowest access to public transit—just three percent of land area is within half a mile of a rapid transit or commuter rail station. Given this, access to jobs via transit is lowest in Submarket 7 as well.
        </p>
        <p>
          Despite the low transit access to jobs, unemployment in Submarket 7 is below the regional average at 4.1 percent, and is second lowest after Submarket 5.
        </p>
      </div>
    ...
    <SectionWithChart>
      <div>
        <p>
          Given the low cost of housing and the relative wealth of residents in Submarket 7, the rate of
          {' '}
          <HoverablePhrase
          ...
          />
          {' '}
          in the submarket is lowest of the seven submarkets at 11 percent—5 points lower than the regional average.
        </p>
        <p>
          Home mortage denial rates in Submarket 7 for
          {' '}
          <HoverablePhrase
          ...
          />
          {' '}
          are average for the region at 10 percent. Denial rates for high-income Black, Latinx, and Indigenous applicants are all higher, at 18 percent, 15 percent, and 13 percent, respectively. For high-income Black applicants, though, a denial rate of 18 percent is the lowest of any of the seven submarkets. For high-income Latinx applicants, it is second lowest, after Submarket 5, and for high-income Indigenous applicants, it is third lowest after Submarkets 5 and 6. Still, the contrast with Asian and White high-income applicants is stark, at rates of eight and nine percent, respectively.
        </p>
        <p>
          Redlining didn’t have an obvious impact on Submarket 7 because in the 1930s not many people lived in the areas that far outside of the core of the region. Almost none of the land area in the submarket was assigned a HOLC grade.
        </p>
      </div>
      <PercentCostBurdened />
    </SectionWithChart>
